  ...
  return (
    <header className="border-b border-slate-800 bg-slate-900/90 backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-3 flex flex-col md:flex-row md:items-center justify-between gap-4">
        {/* Brand & Main Navigation Sections */}
        <div className="flex items-center justify-between md:justify-start gap-6">
          <Link href="/" className="flex items-center gap-3 group shrink-0">
            <span className="p-2 bg-indigo-600 rounded-xl text-white group-hover:bg-indigo-500 transition-colors shadow-md">
              📡
            </span>
            <div>
              <span className="text-lg font-extrabold tracking-tight text-white block">InvestRadar AI</span>
              <span className="text-[10px] text-indigo-400 font-semibold tracking-wider uppercase block">Institutional Research</span>
            </div>
          </Link>

          {/* Structured Research Navigation Links */}
          <nav className="hidden lg:flex items-center gap-1.5 text-xs font-semibold">
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-1 w-52 bg-slate-800/95 border border-slate-700/80 rounded-xl shadow-2xl overflow-hidden backdrop-blur-md opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-all divide-y divide-slate-700/40 z-50">
                ...
                <Link href="/stocks/aapl" className="block px-4 py-2.5 text-xs text-slate-200 hover:bg-indigo-600 hover:text-white transition-colors">
        ...
        {/* User Navigation / Settings / Auth Badge */}
